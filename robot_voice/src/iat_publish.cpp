    ...
    */
    ...
    static void demo_mic(const char* session_begin_params, int time_out)
    {
	    int errcode;
	    int i = 0;
	    ...
	    while(i++ < time_out)
            //printf("time %d\n, and %d\n",i, time_out);
		    sleep(1);
        //wait_for_rec_stop(&iat, time_out);
	    errcode = sr_stop_listening(&iat);
	    if (errcode) {
	...
	ros::init(argc, argv, "voiceRecognition");
	    ...
	    const char* login_params = "appid = 5f6ef0ad, work_dir = .";
	    ...
	    */
        ...
        {
            if(wakeupFlag){
                ROS_INFO("Initiate ROS server...");
	            printf("Hi, I'm listening.\n");
	            printf("Speak in 15 seconds\n");
	            demo_mic(session_begin_params, 5);
